      ...
      <div className="relative z-10 bg-[#0d0d1e]/92 backdrop-blur-3xl rounded-2xl overflow-hidden shadow-[0_30px_80px_rgba(0,0,0,0.6)]">
        ...
        <div className="px-8 py-8 space-y-6">
          ...
          <div className="text-center space-y-1.5">
            <h1 className="text-2xl font-black text-white tracking-tight">Access Portal</h1>
            <p className="text-sm text-white/40 font-medium">Enter your credentials to access your studio</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <button type="button" className="text-xs text-indigo-400/70 hover:text-indigo-300 transition-colors font-medium">Forgot password?</button>
              </div>
              <div className="relative">
